...
export const EXERCISES: readonly ExerciseConfig[] = [
  {
    ...
    placementInstruction:
      "Phone ko side mein, hip height par rakho. Sir se ankle tak poora body visible hona chahiye.",
    ...
    formChecks: [
      {
        ...
        label: "Depth",
        severity: "major",
        cue: "Thoda aur neeche jao.",
      },
      {
        id: "squat-torso",
        label: "Torso lean",
        severity: "major",
        cue: "Chest upar, peeth seedhi rakho.",
      },
    ],
  },
  {
    ...
    requiredView: "side",
    placementInstruction:
      "Phone ko body ke bilkul side mein, floor ke qareeb steady rakho. Plank position mein camera wali shoulder, elbow, haath, hip aur pair poore frame mein dikhao.",
    requiredLandmarks: [
      "leftShoulder",
      "leftElbow",
      "leftWrist",
  ...
  },
  {
    ...
    requiredView: "front",
    placementInstruction:
      "Phone ko saamne chest height par rakho. Dono shoulders aur elbows clearly frame mein hon.",
    requiredLandmarks: [
      "leftShoulder",
      "leftElbow",
      "leftWrist",
    ...
    formChecks: [
      {
        ...
        severity: "major",
        cue: "Curl ko poora complete karo.",
      },
      {
        id: "curl-swing",
        label: "Arm swing",
        severity: "major",
        cue: "Elbow stable rakho.",
      },
    ],
  },
] as const;
